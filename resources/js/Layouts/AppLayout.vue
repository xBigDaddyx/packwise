            ...
            <Sidebar collapsible="icon">
                                        ...
                                        <CommandList>
                                            ...
                                            <CommandGroup heading="Switch Teams">
                                                <CommandItem v-for="team in $page.props.auth.user.all_teams"
                                                    ...
                                                    {{ team.name }}
                                                    <Icon v-if="team.id === $page.props.auth.user.current_team_id"
                ...
                <SidebarContent>
                    ...
                    <SidebarGroup>
                        ...
                        <SidebarMenu>
                            <SidebarMenuItem
                                :class="{ 'font-semibold text-primary bg-secondary rounded': route().current('api-tokens.index') }">
                                <SidebarMenuButton as-child>
                            ...
                            <SidebarMenuItem
                                :class="{ 'font-semibold text-primary bg-secondary rounded': route().current('scribe') }">
                                <SidebarMenuButton as-child>
                                    <a :href="route('scribe')">
                                        <Icon icon="lucide:book-heart" />
                                        API Documentation
                                    </a>
                                </SidebarMenuButton>
                            </SidebarMenuItem>
                    ...
                    <SidebarGroup class="mt-auto">
                        <SidebarMenu>
                            <SidebarMenuItem>
                                <SidebarMenuButton as="a" target="_blank"
                            ...
                            <SidebarMenuItem>
                                <SidebarMenuButton as="a" target="_blank" href="https://docs.larasonic.com">
