...
<template>
    ...
    <div class="flex min-h-screen flex-col items-center justify-center ">
        ...
        <Card class="mx-auto max-w-lg border-primary shadow-md" :class="cn('w-[380px]')">
            <!-- Header -->
            <CardHeader>
                    ...
                    <div class="grid gap-4">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input id="email" v-model="form.email" type="email" placeholder="m@example.com" required
                                autofocus autocomplete="username" class="border-primary focus:ring-primary" />
                        ...
                        <!-- OAuth Providers -->
                        <SocialLoginButton v-for="provider in availableOauthProviders" :key="provider.slug"
                            :provider="provider" :disabled="form.processing" />
